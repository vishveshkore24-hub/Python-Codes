# Design a python application that creates two separate threads named EvenLis and OddList.
# Both thread should accepts one integer number as a prameter
# The EvenList thread should extract all even elements from list. Calculate and display the sum of all even numbers
# The OddList thread should extract all odd elements from list. Calculate and display the sum of all odd numbers
